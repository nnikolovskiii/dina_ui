...
} from './features/document-managment/components/display-content/display-content.component';
import {ChatComponent} from './features/chat/components/chat/chat.component';
import {
  ConfirmProcessingComponent
} from './features/document-managment/components/confirm-processing/confirm-processing.component';
...
import {ServicePageComponent} from './global-features/components/service-page/service-page.component';
import {AboutUsPageComponent} from './global-features/components/about-us-page/about-us-page.component';
...
export const routes: Routes = [
  ...
  {path: 'home', component: DinaHomeComponent},
  {path: 'sign-in', component: SignInComponent},
  {path: 'login', component: LoginComponent},
  {path: 'tmp', component: FooterComponent},
