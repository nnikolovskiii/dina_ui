...
import {DocsContentService} from '../../services/docs-content/docs-content.service';

@Component({
  selector: 'app-display-docs-content',
  standalone: true,
...
export class DisplayContentComponent implements OnInit{
  ...
  constructor(
    ...
    private collectionDataService: DocsContentService,
